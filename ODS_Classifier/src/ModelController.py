...
class ModelController:
    ...
    def __init__(self):
        ...
        # Inicializa el mismo preprocesamiento utilizado durante el entrenamiento.
    ...
    def predict(self, texto):
        ...
        # Aplicamos el mismo preprocesamiento utilizado durante el entrenamiento.
        texto_preprocesado = self.preprocessing.transform(texto)

        # El vectorizador utiliza el vocabulario y los pesos TF-IDF aprendidos durante el entrenamiento.
        X_tfidf = self.vectorizer.transform([texto_preprocesado])
